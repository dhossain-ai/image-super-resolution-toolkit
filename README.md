...
This step makes your GitHub repo look complete and professional.
...
git clone https://github.com/YOUR_USERNAME/super-resolution-comparison-app.git
cd super-resolution-comparison-app
